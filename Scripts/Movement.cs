...
public class Movement : MonoBehaviour
{
    ...
    private void FixedUpdate() {
        ...
        if(directionX > 0) _body.rotation = Quaternion.Euler(0f, 0f, -90f);
        if(directionX < 0) _body.rotation = Quaternion.Euler(0f, 0f, 90f);
        if(directionY > 0) _body.rotation = Quaternion.Euler(0f, 0f, 0f);
        if(directionY < 0) _body.rotation = Quaternion.Euler(0f, 0f, 180f);
    }
}
